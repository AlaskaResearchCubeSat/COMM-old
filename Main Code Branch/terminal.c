...
//*argv[] is a vector for the arguments and contins pointers to each argument
//*dst is a buffer that needs to be big enoughf to hold all the arguments
